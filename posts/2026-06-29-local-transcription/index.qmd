...
| Your machine             | Model                          |
|--------------------------|--------------------------------|
| 8 GB RAM, no NVIDIA GPU  | `small`                        |
| 16 GB RAM, no NVIDIA GPU | `large-v3-turbo`               |
| 32 GB RAM, no NVIDIA GPU | `large-v3-turbo` or `large-v3` |
| NVIDIA GPU, 6 GB+ VRAM   | `large-v3`                     |
