...
author: "Matan Hakim"
date: "2026-07-27"
categories: [AI, learning, Claude Code, data science, RWeekly Highlights]
...
*(This blog post was chosen as a highlight for R Weekly [issue 2026-W32](https://rweekly.org/2026-W32.html), and was discussed on the [R Weekly Highlights podcast](https://serve.podhome.fm/episodepage/r-weekly-highlights/issue-2026-w32-highlights) in episode 238)*
...
Think about how you picked up a genuinely new skill in the old world, which is to say eighteen months ago. Say you wanted to learn Shiny, the framework for building reactive web apps in R. You read ["Mastering Shiny"](https://mastering-shiny.org/), or opened the docs, and worked through them. You started a toy project on the side. You hit a wall, searched, landed on Stack Overflow, and when nothing fit you distilled the problem into a [reproducible example](https://reprex.tidyverse.org/) and asked your own question. Eventually you got unstuck and went back to the toy project.
...
In an earlier post I argued that data scientists are [unusually well positioned for the AI era](../2026-06-24-data-scientists-ai-revolution/index.qmd) because the role already demanded the right mix of skills. This is the complimentary insight. The floor rose, the tools are sitting right there, and the only upgrade still required is in your willingness to reach.
